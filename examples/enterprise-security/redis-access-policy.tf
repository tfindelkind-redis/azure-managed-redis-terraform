...
# NOTE: The resource type azurerm_redis_enterprise_database_access_policy_assignment
# is not available in azurerm provider v4.50. Access policies need to be configured
# using AzAPI or Azure CLI after deployment.
